...
## Create a virtual environment
    ...
    # 2. Use the following command to call the venv module.
    # Console
    # python -m venv env
    ...
    # Your environment needs the env directory to keep track of details like which version of Python and which libraries you're using. 
    # Don't put your program files in the env directory. 
    # We suggest that you put your files in a directory called src or something similar. 
    # The project structure might then look like this:
...
## Activate the virtual environment
    # At this point, you have a virtual environment, but you haven't started using it. 
    # To use it, you need to activate it by calling an activate script.
...
#%%
# What's a package?
    # One of the main advantages of using external libraries is to speed up the development time of your program. 
    # You can fetch such a library on the internet. But by fetching and installing these libraries through a virtual environment, you ensure that you install theses libraries only for the virtual environment and not globally for the entire machine.
...
# Use an installed package
    ...
    # Output
    # 2023-06-16 12:37:57.431535
    # 2023-07-23 10:37:57.431535
